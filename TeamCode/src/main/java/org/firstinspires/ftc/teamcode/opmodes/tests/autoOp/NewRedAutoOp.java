...
public class NewRedAutoOp extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            switch (autoState) {
                ...
                case RESET: //set position for ball 1
                    ...
                    break;
                //Align with the artifacts, intake them, sort, move forward, and repeat the last two steps until sorter is full
                case COLLECTION_1:
                    switch (stage) {
