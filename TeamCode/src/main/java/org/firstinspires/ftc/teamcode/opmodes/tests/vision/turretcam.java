...
public class turretcam extends LinearOpMode {
   ...
   // final double SPEED_GAIN  =  0.08  ;   //  Forward Speed Control "Gain". e.g. Ramp up to 50% power at a 25 inch error.   (0.50 / 25.0)
 ...
 //   final double MAX_AUTO_SPEED = 0.5;   //  Clip the approach speed to this max value (adjust for your robot)
  //  final double MAX_AUTO_STRAFE= 0.5;   //  Clip the strafing speed to this max value (adjust for your robot)
    ...
    private DcMotorEx turretcam = null;  //  Used to control the turret motor
 ...
 //           strafe = -gamepad1.left_stick_x  / 2.0;  // Reduce strafe rate to 50%.
   ...
   //             telemetry.addData("Manual","Drive %5.2f, Strafe %5.2f, Turn %5.2f ", drive, strafe, turn);
    ...
    /*
     ...
     This can only be called AFTER calling initAprilTag(), and only works for  cams;
    */
