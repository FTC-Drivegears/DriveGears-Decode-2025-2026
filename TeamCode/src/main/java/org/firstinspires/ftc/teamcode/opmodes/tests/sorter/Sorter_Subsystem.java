package org.firstinspires.ftc.teamcode.opmodes.tests.sorter;
...
public class Sorter_Subsystem {
    ...
    public Sorter_Subsystem(Hardware hw, LinearOpMode opMode, Telemetry telemetry){
